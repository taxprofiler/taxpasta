...
@unique
class TableReaderFileFormat(str, Enum):
    ...
    @classmethod
    def guess_format(cls, filename: Path) -> TableReaderFileFormat:
        """
    ...
    @classmethod
    def check_dependencies(cls, file_format: TableReaderFileFormat) -> None:
        """
