...
"""Provide a mixin with useful file format methods."""
...
FileFormat = TypeVar("FileFormat", bound=Enum)


class FileFormatMixin(Generic[FileFormat]):
    """Define a mixin with useful file format methods."""

    @classmethod
    def guess_format(cls, filename: Path) -> FileFormat:
        """
    ...
    @classmethod
    def check_dependencies(cls, file_format: FileFormat) -> None:
        """
